...
# TodoListsController
def show
  @@todo_list = TodoList.find_by(user_id: params[:user_id])
...
def create
  ...
  def destroy
    ...
    # Destroy associated todo items first (if needed)
    @todo_list.todo_items.destroy_all if @todo_list.todo_items.any?
